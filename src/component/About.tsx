...
const About: React.FC = () => {
  const links = [
    { label: "Our Products", img: "/frontend/images/slide4.png" },
    { label: "Our Stores", img: "/frontend/images/slide4.png" },
    { label: "Careers", img: "/frontend/images/slide4.png" },
  ];
...
<p>The Griffin Original — FEEL THE RICHNESS</p>
            ...
            <div className="col-md-6">
              <img
                src="/frontend/images/product1.png"
  ...
  <div className="col-md-6">
    <img
      src="/frontend/images/slide4.png"
      alt="Model"
    ...
    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit...</p>
      ...
      <section className="container-fluid p-0">
        <div className="row g-0 align-items-center">
          ...
          <div className="col-md-6">
            <img src="/frontend/images/p6.jpg" className="img-fluid w-100" style={{ height: '400px', objectFit: 'cover' }} alt="Fragrance bottle" />
          </div>
        </div>
      </section>
