            ...
            <div className="col-6">
              <div className="card h-100 border-0 shadow-sm">
                <div className="row g-0 align-items-center">
                  ...
                  <img src="/frontend/images/product1.png" className="img-fluid rounded-start" alt="Gift 1" />
            ...
            <div className="col-6">
              <div className="card h-100 border-0 shadow-sm">
                <div className="row g-0 align-items-center">
                  ...
                  <img src="/frontend/images/product2.png" className="img-fluid rounded-start" alt="Gift 1" />
                  <div className="card-body text-center">
                    <p className="card-text text-muted small">Timeless scents that turn heads with sophistication.</p>
                    <p className="readmore"><a href="#">Read More </a></p>
                  </div>
