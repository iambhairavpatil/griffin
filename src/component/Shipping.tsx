        ...
        <div className="container">
          <div className="row text-center g-4">
            ...
            <div className="col-md-4">
              <img src="/frontend/images/icon1.png" alt="Shipping" className="mb-3" style={{ width: '78px' }} />
            ...
            <div className="col-md-4">
              <img src="/frontend/images/icon2.png" alt="Eco Friendly" className="mb-3" style={{ width: '78px' }} />
            ...
            <div className="col-md-4">
              <img src="/frontend/images/icon3.png" alt="Store" className="mb-3" style={{ width: '78px' }} />
